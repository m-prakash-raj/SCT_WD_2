A simple stopwatch app built using HTML, CSS, and JavaScript. This app allows users to start, stop, and reset a timer, making it perfect for tracking time spent on tasks, exercises, or any other activity.
